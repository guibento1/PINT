...
CREATE TABLE Licao (
    ...
    CONSTRAINT CURSO_LICAO_FK FOREIGN KEY (curso) REFERENCES Curso(idCurso) ON DELETE CASCADE
...
CREATE TABLE LicaoMaterial (
    ...
    CONSTRAINT LICAO_LICAOMATERIAL_FK FOREIGN KEY (licao) REFERENCES Licao(idLicao) ON DELETE CASCADE,
...
CREATE TABLE AvaliacaoFinal (
    ...
    CONSTRAINT CURSO_AVALIACAOFINAL_FK FOREIGN KEY (cursoSincrono) REFERENCES CursoSincrono(idCursoSincrono) ON DELETE CASCADE,
...
CREATE TABLE AvaliacaoContinua (
    ...
    CONSTRAINT CURSOSINCRONO_AVALIACAOCONTINUA_FK FOREIGN KEY(cursoSincrono) REFERENCES cursoSincrono(idCursoSincrono) ON DELETE CASCADE,
...
CREATE TABLE Submissao (
    ...
    CONSTRAINT AVALIACAOCONTINUA_SUBMISSAO_FK FOREIGN KEY (avaliacaoContinua,CursoSincrono) REFERENCES AvaliacaoContinua(IdAvaliacaoContinua,CursoSincrono) ON DELETE CASCADE,
...
CREATE TABLE CanaisUtilizadores (
    ...
    CONSTRAINT CANAL_CANAISUTILIZADORES_FK FOREIGN KEY (canal) REFERENCES CanalNotificacoes(idCanalNotificacoes)

);


CREATE TABLE TopicosSubscritosUtilizadores (

    topico BIGINT,
    utilizador BIGINT,


    CONSTRAINT TOPICOSSUBSCRITOSUTILIZADORES_PK PRIMARY KEY(topico,utilizador),
    CONSTRAINT UTILIZADOR_TOPICOSSUBSCRITOSUTILIZADORES_FK FOREIGN KEY (utilizador) REFERENCES Utilizadores(idUtilizador) ON DELETE CASCADE,
    CONSTRAINT TOPICO_TOPICOSSUBSCRITOSUTILIZADORES_FK FOREIGN KEY (topico) REFERENCES Topico(idtopico) ON DELETE CASCADE
