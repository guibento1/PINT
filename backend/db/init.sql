...
CREATE TABLE IteracaoPost (
    post BIGINT,
    utilizador BIGINT,
    positiva BOOLEAN NOT NULL,

    CONSTRAINT POST_ITERACAOPOST_FK FOREIGN KEY (post) REFERENCES Post(idPost) ON DELETE CASCADE,
    CONSTRAINT POST_ITERACAO_PK PRIMARY KEY(post, utilizador),
    CONSTRAINT UTILIZADOR_ITERACAO_FK FOREIGN KEY (utilizador) REFERENCES Utilizadores(idUtilizador)
);
...
CREATE TABLE Comentario (
    ...
    conteudo TEXT NOT NULL,
    pontuacao BIGINT NOT NULL DEFAULT 0,
    nRespostas BIGINT NOT NULL DEFAULT 0,
    criado TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IteracaoComentario (
    comentario BIGINT,
    utilizador BIGINT,
    positiva BOOLEAN NOT NULL,

    CONSTRAINT COMENTARIO_ITERACAOPOST_FK FOREIGN KEY (comentario) REFERENCES Comentario(idComentario) ON DELETE CASCADE,
    CONSTRAINT COMENTARIO_ITERACAO_PK PRIMARY KEY(comentario, utilizador),
    CONSTRAINT UTILIZADOR_ITERACAO_FK FOREIGN KEY (utilizador) REFERENCES Utilizadores(idUtilizador)
);
...
CREATE TABLE RespostaPost (
    ...
    CONSTRAINT RESPOSTAPOST_PK PRIMARY KEY(idComentario, post),
    CONSTRAINT COMENTARIO_RESPOSTAPOST_FK FOREIGN KEY (idComentario) REFERENCES Comentario(idComentario) ON DELETE CASCADE,
    CONSTRAINT POST_RESPOSTAPOST_FK FOREIGN KEY (post) REFERENCES Post(idPost) ON DELETE CASCADE
...
CREATE TABLE RespostaComentario (
    ...
    CONSTRAINT RESPOSTACOMENTARIO_PK PRIMARY KEY(idComentario, comentario),
    CONSTRAINT COMENTARIO_RESPOSTACOMENTARIO_FK FOREIGN KEY (idComentario) REFERENCES Comentario(idComentario) ON DELETE CASCADE,
    CONSTRAINT COMENTARIOORIGINAL_RESPOSTACOMENTARIO_FK FOREIGN KEY (comentario) REFERENCES Comentario(idComentario) ON DELETE CASCADE
);
...
CREATE TABLE DenunciaPost (
    ...
    CONSTRAINT POST_DENUNCIAPOST_FK FOREIGN KEY (post) REFERENCES Post(idPost) ON DELETE CASCADE,
    CONSTRAINT DENUNCIA_DENUNCIAPOST_FK FOREIGN KEY (denuncia) REFERENCES Denuncia(idDenuncia) ON DELETE CASCADE
);
...
CREATE TABLE DenunciaComentario (
    ...
    CONSTRAINT COMENTARIO_DENUNCIACOMENTARIO_FK FOREIGN KEY (comentario) REFERENCES Comentario(idComentario) ON DELETE CASCADE,
    CONSTRAINT DENUNCIA_DENUNCIACOMENTARIO_FK FOREIGN KEY (denuncia) REFERENCES Denuncia(idDenuncia) ON DELETE CASCADE
);
