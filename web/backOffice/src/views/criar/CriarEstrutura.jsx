...
export default function CriarEstrutura() {
    ...
    const fetchInitialData = async () => {
      ...
      try {
        ...
        if (resCategorias.data.length > 0) {
          setAreaCategoriaSelecionada(
            resCategorias.data[0].idcategoria.toString()
          );
        }
  ...
  const handleCreateTopico = async (e) => {
    ...
    try {
      ...
      setOperationStatus(1);
      setOperationMessage(
        error.response?.data?.message || "Erro ao criar tópico."
      );
    } finally {
      setLoading(false);
      openResultModal();
    ...
    <div className="container mt-4">
      ...
      <div className="tab-content" id="myTabContent">
        ...
        <div
          ...
          } p-3 border border-top-0 rounded-bottom`}
          id="categoria"
          role="tabpanel"
        ...
        >
          <form onSubmit={handleCreateCategoria}>
            <div className="mb-3">
              <label htmlFor="categoriaDesignacao" className="form-label">
        ...
        >
          <form onSubmit={handleCreateArea}>
            <div className="mb-3">
              <label htmlFor="areaDesignacao" className="form-label">
                Designação da Área
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label htmlFor="areaCategoria" className="form-label">
                Categoria
              </label>
              <select
        ...
        >
          <form onSubmit={handleCreateTopico}>
            <div className="mb-3">
              <label htmlFor="topicoDesignacao" className="form-label">
                  ...
                  {areas.map((area) => (
                    <div className="form-check" key={area.idarea}>
                      <input
                        ...
                        checked={topicoAreasSelecionadas.includes(
                          area.idarea.toString()
                        )}
                        disabled={loading}
                      />
                      <label
