...
export default function EditarTopico() {
    ...
    useEffect(() => {
        const fetchTopicoData = async () => {
            ...
            try {
                ...
                setError('Não foi possível carregar o tópico ou áreas. Tente novamente mais tarde.');
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setOperationMessage(err.response?.data?.message || 'Erro ao atualizar tópico.');
        } finally {
            setSubmitting(false);
            openResultModal();
        }
    ...
    if (loading) {
        return <div className="container mt-4"><p>A carregar tópico...</p></div>;
    }
    ...
    return (
        <div className="container mt-4">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label htmlFor="designacaoTopico" className="form-label">Designação do Tópico</label>
                    <input
                        type="text"
                ...
                <button type="submit" className="btn btn-primary me-2" disabled={submitting || areasSelecionadas.length === 0}>
