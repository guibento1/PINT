...
export default function EditarCategoria() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setOperationMessage(err.response?.data?.message || 'Erro ao atualizar categoria.');
        } finally {
            setSubmitting(false);
            openResultModal();
        }
    ...
    if (loading) {
        return <div className="container mt-4"><p>A carregar categoria...</p></div>;
    }
    ...
    return (
        <div className="container mt-4">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    <label htmlFor="designacaoCategoria" className="form-label">Designação da Categoria</label>
                    <input
                        type="text"
